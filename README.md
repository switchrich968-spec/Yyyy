      ...
      <article className="max-w-3xl mx-auto px-6 py-16 prose prose-invert">
        ...
        <section className="space-y-6 text-gray-300">
          <div>
            ...
            <p>We collect information you provide directly: email address, name, and the data you choose to process through our automation workflows.</p>
          </div>

          <div>
            <h2 className="text-xl font-semibold text-white mb-2">2. How We Use Your Information</h2>
            <p>We use your information to: provide and improve our services, execute your workflows, communicate with you, and ensure platform security.</p>
          </div>

          <div>
            <h2 className="text-xl font-semibold text-white mb-2">3. Third-Party Services</h2>
            <p>Noracan integrates with third-party services (Gmail, Slack, OpenAI, etc.) as authorized by you. Each service has its own privacy policy. We process data only as needed to execute your workflows.</p>
          </div>

          <div>
            <h2 className="text-xl font-semibold text-white mb-2">4. Data Security</h2>
            <p>We encrypt data at rest and in transit. OAuth credentials are stored encrypted and never exposed in logs. Access is restricted to authorized personnel.</p>
          </div>

          <div>
            <h2 className="text-xl font-semibold text-white mb-2">5. Data Retention</h2>
            <p>Execution logs are retained for 90 days by default. You can delete your account and all associated data at any time from your account settings.</p>
          </div>

          <div>
            <h2 className="text-xl font-semibold text-white mb-2">6. Your Rights</h2>
            <p>You can access, update, or delete your personal data at any time. Contact us at privacy@noracan.app for any privacy-related requests.</p>
          </div>

          <div>
            <h2 className="text-xl font-semibold text-white mb-2">7. Contact</h2>
            <p>Questions about this policy? Email us at privacy@noracan.app.</p>
          </div>
        </section>
      </article>
    </div>
